...
public static class InputParser
{
	...
	//.#...##..#.
	// trueCharacter = #
	public static bool[,] ParseBool2DArray(string input, char separator, char trueCharacter, bool flipY)
	{
		...
		for (int y = 0; y < lines.Length; y++)
		{
			...
			{
				var gridY = flipY ? lines.Length - y - 1 : y;
				grid[x, gridY] = lines[y][x] == trueCharacter;
			}
	...
	public static Vector2Int APoint(string str, char xySeperator)
	{
	...
	public static List<Vector2Int> ListOfPoints(string str, char lineSeparator, char xySeperator)
	{
