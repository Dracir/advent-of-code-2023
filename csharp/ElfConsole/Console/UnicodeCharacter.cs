public static class UnicodeCharacter
{
	...
	public static char BOX_CORNER_BOTTOM_RIGHT = '┘';
	public static char BOX_CORNER_BOTTOM_LEFT = '└';
	public static char BOX_CORNER_TOP_LEFT = '┌';
	public static char BOX_CORNER_ROUNDED_TOP_RIGHT = '╮';
	public static char BOX_CORNER_ROUNDED_BOTTOM_RIGHT = '╯';
	public static char BOX_CORNER_ROUNDED_BOTTOM_LEFT = '╰';
	public static char BOX_CORNER_ROUNDED_TOP_LEFT = '╭';
	public static char BOX_HORIZONTAL = '─';
